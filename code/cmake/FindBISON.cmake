...
if (BISON_ROOT)
    message(STATUS "look for bison @ ${BISON_ROOT}/bin")
    find_program(BISON_EXECUTABLE NAMES bison win_bison HINTS ${BISON_ROOT}/bin DOC "path to the bison executable")
else()
    message(STATUS "look for bison in system")
