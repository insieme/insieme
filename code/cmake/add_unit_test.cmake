...
macro ( add_unit_test case_name ut_prefix )
	...
	if(NOT TARGET googletest) 
		...
		ExternalProject_Add(googletest
			...
			CMAKE_ARGS -DCMAKE_MAKE_PROGRAM=${CMAKE_MAKE_PROGRAM} -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} -Dgtest_force_shared_crt=${MSVC_SHARED_RUNTIME} -DBUILD_SHARED_LIBS=${googletest_BUILD_SHARED_LIBS}
			BUILD_BYPRODUCTS
				${gtest_lib}
				${gtest_main_lib}
