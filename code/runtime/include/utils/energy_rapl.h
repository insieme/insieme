...
/*
 *
 * General instructions on how to do energy measurements with the runtime instrumentation system:
 *
 *
 */
...
uint64 _irt_read_msr(int32 file, int32 which) {
	uint64 data;

	if (pread(file, &data, sizeof data, which) != sizeof data)
