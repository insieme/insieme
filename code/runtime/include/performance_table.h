...
typedef enum {
        ...
        PERFORMANCE_DATA_ENTRY_ENERGY_MC_1 = 1, // energy consumed
        PERFORMANCE_DATA_ENTRY_ENERGY_CORES_1 = 2, // energy consumed
        PERFORMANCE_DATA_ENTRY_ENERGY_PACKAGE_2 = 3, // energy consumed
        PERFORMANCE_DATA_ENTRY_ENERGY_MC_2 = 4, // energy consumed
        PERFORMANCE_DATA_ENTRY_ENERGY_CORES_2 = 5, // energy consumed
        PERFORMANCE_DATA_ENTRY_MEMORY_VIRT = 6, // virtual memory size
        PERFORMANCE_DATA_ENTRY_MEMORY_RES = 7, // resident set size
        PERFORMANCE_DATA_ENTRY_TEMPERATURE = 8,
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_1 = 9,
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_2 = 10,
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_3 = 11,
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_4 = 12, 
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_5 = 13, 
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_6 = 14, 
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_7 = 15, 
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_8 = 16, 
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_9 = 17, 
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_10 = 18, 
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_11 = 19, 
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_12 = 20, 
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_13 = 21, 
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_14 = 22, 
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_15 = 23, 
        PERFORMANCE_DATA_ENTRY_PAPI_COUNTER_16 = 24, 
