...
TEST(Term, Contains) {
	...
	irt_range_term_2d term = irt_range_term_2d_create(
		irt_range_point_2d_create(0,1),
		irt_range_point_2d_create(10,10),
		irt_range_point_2d_create(2,3)
	);
...
TEST(Term, Empty) {
	...
	irt_range_term_1d te1 = irt_range_term_1d_create(
		irt_range_point_1d_create(0),
		irt_range_point_1d_create(-10),
		irt_range_point_1d_create(1)
	);

	irt_range_term_2d te2 = irt_range_term_2d_create(
		irt_range_point_2d_create(0,0),
		irt_range_point_2d_create(0,5),
		irt_range_point_2d_create(1,1)
	);

	irt_range_term_3d te3 = irt_range_term_3d_create(
		irt_range_point_3d_create(0,0,0),
		irt_range_point_3d_create(0,5,7),
		irt_range_point_3d_create(1,1,2)
	);
	...
	irt_range_term_1d tn1 = irt_range_term_1d_create(
		irt_range_point_1d_create(0),
		irt_range_point_1d_create(3),
		irt_range_point_1d_create(1)
	);

	irt_range_term_2d tn2 = irt_range_term_2d_create(
		irt_range_point_2d_create(0,0),
		irt_range_point_2d_create(3,5),
		irt_range_point_2d_create(1,1)
	);

	irt_range_term_3d tn3 = irt_range_term_3d_create(
		irt_range_point_3d_create(0,0,0),
		irt_range_point_3d_create(3,5,7),
		irt_range_point_3d_create(1,1,2)
	);
	...
	for(int i=0; i<100; i++) {
		for (int j=0; j<100; j++) {
			for (int k=1; k<100; k++) {
				...
				uint64 count = 0;
				for(int h=0; h<100; h++) {
					if (irt_range_term_1d_contains(&t, irt_range_point_1d_create(h))) {
						count++;
					}
				}
						...
						for (int k2=1; k2<N; k2++) {
							...
							for(int h1=0; h1<N; h1++) {
								for(int h2=0; h2<N; h2++) {
									if (irt_range_term_2d_contains(&t, irt_range_point_2d_create(h1,h2))) {
										count++;
									}
								}
							}
