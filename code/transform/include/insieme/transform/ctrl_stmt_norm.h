...
/**
 * An utility function to remove jumps in the control flow (due to use of break/continue/return statements)
 * from the program and replace them with semantically equivalent if-then-else control statements.
 * @param root
 ...
 */
insieme::core::NodePtr normalizeCtrlStmt(insieme::core::NodePtr root, bool preservePtrAnnotationsWhenModified=false);
