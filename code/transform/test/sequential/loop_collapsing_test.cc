...
namespace sequential {
	...
	TEST(Transformations, OneLevelCollapsing) {
		...
		auto transformed = makeLoopCollapsing(1)->apply(forStmt);
...
//		std::cout << res;
	...
	TEST(Transformations, TwoLevelCollapsing) {
		...
		auto transformed = makeLoopCollapsing(2)->apply(forStmt);
		auto res = toString(core::printer::PrettyPrinter(transformed, core::printer::PrettyPrinter::OPTIONS_DETAIL));
