...
namespace extensions {
	...
	/**
	 * Implements a semantic mapping for the C std library functions "malloc" and "free"
	 */
	class MallocExtension : public insieme::frontend::extensions::FrontendExtension {
	  public:
