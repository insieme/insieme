...
public:
	...
	IRTranslationUnit(core::NodeManager& mgr, const TypeMap& types, const FunctionMap& functions, const GlobalsList& globals, const Initializer& initializer,
	                  const EntryPointList& entryPoints, const MetaInfoMap& metaInfos, bool cppCode)
	...
	IRTranslationUnit(const IRTranslationUnit& other)
		: mgr(other.mgr), types(other.types), functions(other.functions), globals(other.globals), initializer(other.initializer), entryPoints(other.entryPoints),
		  metaInfos(other.metaInfos), isCppCode(other.isCppCode) {}
