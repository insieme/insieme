...
/*
	...
	*/
	EXPECT_EQ("AP(rec v0.{v0=fun() {ref<int<4>> v1 = rec v0.{v0=fun('a v1) {ref<'a> v2 = ref.alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc.stack); ref.assign(v2, v1); return v2;}}(0); ref<int<4>> v2 = rec v0.{v0=fun('a v1) {ref<'a> v2 = ref.alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc.stack); ref.assign(v2, v1); return v2;}}(0); {parallel(job [] (default: bind(){rec v0.{v0=fun() {ref<int<4>> v1 = rec v0.{v0=fun('a v1) {ref<'a> v2 = ref.alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc.stack); ref.assign(v2, v1); return v2;}}(3);}}()}));}; return 0;}})", toString(progEntry));
}
...
/*
	...
	EXPECT_EQ(toString(core::printer::PrettyPrinter(resEntry)), toString(core::printer::PrettyPrinter(progEntry)));
	*/
	EXPECT_EQ("AP(rec v0.{v0=fun() {ref<int<4>> v1 = rec v0.{v0=fun('a v1) {ref<'a> v2 = ref.alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc.stack); ref.assign(v2, v1); return v2;}}(0); ref<int<4>> v2 = rec v0.{v0=fun('a v1) {ref<'a> v2 = ref.alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc.stack); ref.assign(v2, v1); return v2;}}(0); ref<vector<int<4>,3>> v3 = rec v0.{v0=fun('a v1) {ref<'a> v2 = ref.alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc.stack); ref.assign(v2, v1); return v2;}}(undefined(type<vector<int<4>,3>>)); {parallel(job [] (default: bind(){rec v0.{v0=fun(ref<int<4>> v1) {ref.assign(v1, int.add(int.mul(pickInRange(0, int.div(int.sub(10, 0), 2), 0, 0, 0), 2), 0)); ref<int<4>> v2 = rec v0.{v0=fun('a v1) {ref<'a> v2 = ref.alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc.stack); ref.assign(v2, v1); return v2;}}(ref.deref(v1));}}(v1)}));}; {merge(parallel(job [] (default: bind(){rec v0.{v0=fun(ref<int<4>> v1, ref<vector<int<4>,3>> v2) {ref.assign(v1, ref.deref(rec v0.{v0=fun(ref<vector<'elem,#l>> v1, uint<8> v2) {return ref.narrow(v1, dp.element(dp.root, v2), type<'elem>);}}(v2, pickInRange(1, 3ul, 0, 0, 0)))); {ref<int<4>> v3 = rec v0.{v0=fun('a v1) {ref<'a> v2 = ref.alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc.stack); ref.assign(v2, v1); return v2;}}(ref.deref(v1));}; mergeAll();}}(v1, v3)})));}; return 0;}})", toString(progEntry));
}
...
/*
	...
	EXPECT_EQ(toString(core::printer::PrettyPrinter(resEntry)), toString(core::printer::PrettyPrinter(progEntry)));
	*/
	EXPECT_EQ("AP(rec v0.{v0=fun() {ref<int<4>> v1 = rec v0.{v0=fun('a v1) {ref<'a> v2 = ref.alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc.stack); ref.assign(v2, v1); return v2;}}(5); {int<4> v2 = ref.deref(v1); parallel(job [] (default: bind(){rec v0.{v0=fun(int<4> v1) {ref<int<4>> v2 = rec v0.{v0=fun('a v1) {ref<'a> v2 = ref.alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc.local); ref.assign(v2, v1); return v2;}}(v1); {ref<int<4>> v3 = rec v0.{v0=fun('a v1) {ref<'a> v2 = ref.alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc.stack); ref.assign(v2, v1); return v2;}}(int.add(ref.deref(v2), 3));}; ref.delete(v2);}}(v2)}));}; return 0;}})", toString(progEntry));
}
