	...
	insieme::core::TypePtr PostVisit(const clang::Type* type, const insieme::core::TypePtr& irType, insieme::frontend::conversion::Converter& convFact) {
		...
		if(const clang::BuiltinType* builtin = llvm::dyn_cast<clang::BuiltinType>(type)) {
			...
			case clang::BuiltinType::Void:
				EXPECT_EQ("unit", toString(*irType));
				break;
			case clang::BuiltinType::Bool:
				EXPECT_EQ("bool", toString(*irType));
				break;
				
			// char types
			case clang::BuiltinType::Char_U:
				EXPECT_EQ("uint<1>", toString(*irType));
				break;
			case clang::BuiltinType::UChar:
				EXPECT_EQ("uint<1>", toString(*irType));
				break;
			case clang::BuiltinType::Char16:
				EXPECT_EQ("wchar<16>", toString(*irType));
				break;
			case clang::BuiltinType::Char32:
				EXPECT_EQ("wchar<32>", toString(*irType));
				break;
			case clang::BuiltinType::Char_S:
				EXPECT_EQ("char", toString(*irType));
				break;
			...
			case clang::BuiltinType::UShort:
				EXPECT_EQ("uint<2>", toString(*irType));
				break;
			case clang::BuiltinType::Short:
				EXPECT_EQ("int<2>", toString(*irType));
				break;
			case clang::BuiltinType::UInt:
				EXPECT_EQ("uint<4>", toString(*irType));
				break;
			case clang::BuiltinType::Int:
				EXPECT_EQ("int<4>", toString(*irType));
				break;
			case clang::BuiltinType::UInt128:
				EXPECT_EQ("uint<16>", toString(*irType));
				break;
			case clang::BuiltinType::Int128:
				EXPECT_EQ("int<16>", toString(*irType));
				break;
			case clang::BuiltinType::ULong:
				EXPECT_EQ("uint<8>", toString(*irType));
				break;
			case clang::BuiltinType::Long:
				EXPECT_EQ("int<8>", toString(*irType));
				break;
			...
			case clang::BuiltinType::Float:
				EXPECT_EQ("real<4>", toString(*irType));
				break;
			case clang::BuiltinType::Double:
				EXPECT_EQ("real<8>", toString(*irType));
				break;
			case clang::BuiltinType::LongDouble:
				EXPECT_EQ("real<16>", toString(*irType));
				break;
				
			// not supported types
			case clang::BuiltinType::NullPtr:
				EXPECT_EQ("'nullptr_t", toString(*irType));
				break;
