...
void basic_type_test() {
	...
	#pragma test expected "decl ref<ref<array<int<4>,1>>> v0 =  var(ref.reinterpret(ref.null, type<array<int<4>,1>>))"
	int* b1 = 0;

	#pragma test expected "decl ref<ref<array<ref<array<ref<array<int<4>,1>>,1>>,1>>> v0 =  var(ref.reinterpret(ref.null, type<array<ref<array<ref<array<int<4>,1>>,1>>,1>>))"
	int*** c1 = 0;

	#pragma test expected "v100 := ref.reinterpret(ref.null, type<array<ref<array<ref<array<int<4>,1>>,1>>,1>>)"
	c1 = 0;
...
void mem_alloc() {
	...
	#pragma test expected "decl ref<ref<array<int<4>,1>>> v0 =  var(ref.reinterpret(malloc(4ul), type<array<int<4>,1>>))"
	int* a = malloc(4);
