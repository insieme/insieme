...
int main() {
	...
	#pragma test expect_ir(R"({
		...
		instantiate(lit("target_type" : IMP_basic_ostream<ref<char,f,f,qualified>>::(ptr<(ref<IMP_basic_ostream<ref<char,f,f,qualified>>,f,f,cpp_ref>) -> unit,t,f>) -> ref<IMP_basic_ostream<ref<char,f,f,qualified>>,f,f,cpp_ref>), lit("IMP_basic_ostream::IMP_op" : IMP_basic_ostream<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>::(ptr<(ref<IMP_basic_ostream<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>,f,f,cpp_ref>) -> unit,t,f>) -> ref<IMP_basic_ostream<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>,f,f,cpp_ref>))(v1, ptr_of_function(instantiate(lit("target_type" : (ref<IMP_basic_ostream<ref<char,f,f,qualified>>,f,f,cpp_ref>) -> unit), lit("IMP_endl" : (ref<IMP_basic_ostream<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>,f,f,cpp_ref>) -> unit)))) materialize ;
	})")
	{
		ostream os;
		ostream& osr = os;
