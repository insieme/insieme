...
int main() {
	...
	#pragma test expect_ir(R"(instantiate_fun(lit("target_type" : <ref<int<4>,f,f,qualified>>() -> int<4>), lit("IMP_templateFunRet" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>() -> 'T_0_0))())")
	templateFunRet<int>();
	#pragma test expect_ir(R"(instantiate_fun(lit("target_type" : <ref<real<4>,f,f,qualified>>() -> real<4>), lit("IMP_templateFunRet" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>() -> 'T_0_0))())")
	templateFunRet<float>();
	#pragma test expect_ir(R"(instantiate_fun(lit("target_type" : <ref<int<4>,f,f,qualified>, ref<uint<4>,f,f,qualified>>(uint<4>) -> int<4>), lit("IMP_templateFunRetParam" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>, ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>('T_0_1) -> 'T_0_0))(7u))")
	templateFunRetParam<int>(7u);
	#pragma test expect_ir(R"(instantiate_fun(lit("target_type" : <ref<int<4>,f,f,qualified>, ref<uint<4>,f,f,qualified>>(uint<4>) -> int<4>), lit("IMP_templateFunRetParam" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>, ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>('T_0_1) -> 'T_0_0))(6u))")
	templateFunRetParam<int,unsigned>(6u);


	#pragma test expect_ir(R"( instantiate_fun(lit("target_type" : (int<4>) -> int<4>), lit("IMP_templateFun" : ('T_0_0) -> 'T_0_0))(1) )")
	templateFun(1);
	#pragma test expect_ir(R"( instantiate_fun(lit("target_type" : (real<8>) -> real<8>), lit("IMP_templateFun" : ('T_0_0) -> 'T_0_0))(2.0E+0) )")
	templateFun(2.0);
	#pragma test expect_ir(R"( instantiate_fun(lit("target_type" : (uint<16>) -> uint<16>), lit("IMP_templateFun" : ('T_0_0) -> 'T_0_0))(3ull) )")
	templateFun(3ull);
	#pragma test expect_ir(R"( instantiate_fun(lit("target_type" : <ref<uint<8>,f,f,qualified>>(uint<8>) -> uint<8>), lit("IMP_templateFun" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>('T_0_0) -> 'T_0_0))(num_cast(4, type_lit(uint<8>))) )")
	templateFun<unsigned long>(4);

	// Dependent name
	#pragma test expect_ir(R"(instantiate_fun(lit("target_type" : <ref<IMP_Typer,f,f,qualified>>(int<4>) -> unit), lit("IMP_dependentNameFun" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>('IMP_typename_space_T_colon__colon_Bla) -> unit))(5))")
	...
	#pragma test expect_ir(R"({
		...
		instantiate_member(lit("target_type" : <ref<int<4>,f,f,qualified>>IMP_ClassWithTemplateMethod::() -> int<4>), lit("IMP_ClassWithTemplateMethod::IMP_get" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>IMP_ClassWithTemplateMethod::() -> 'T_0_0))(v0);
		instantiate_member(lit("target_type" : <ref<real<4>,f,f,qualified>>IMP_ClassWithTemplateMethod::() -> real<4>), lit("IMP_ClassWithTemplateMethod::IMP_get" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>IMP_ClassWithTemplateMethod::() -> 'T_0_0))(v0);
	})")
	{
	...
	#pragma test expect_ir(R"(instantiate_fun(lit("target_type" : (ptr<(real<4>) -> int<4>,t,f>) -> unit), lit("IMP_templateFunPointerParam" : (ptr<('T_0_1) -> 'T_0_0,t,f>) -> unit))(ptr_of_function(instantiate_fun(lit("target_type" : <ref<int<4>,f,f,qualified>, ref<real<4>,f,f,qualified>>(real<4>) -> int<4>), lit("IMP_templateFunRetParam" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>, ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>('T_0_1) -> 'T_0_0)))))")
	templateFunPointerParam(templateFunRetParam<int,float>);

	#pragma test expect_ir(R"(lit("IMP_specificFunPointerParam" : (ptr<(real<4>) -> int<4>,t,f>) -> unit)(ptr_of_function(instantiate_fun(lit("target_type" : (real<4>) -> int<4>), lit("IMP_templateFunRetParam" : ('T_0_1) -> 'T_0_0)))))")
	specificFunPointerParam(templateFunRetParam);

	#pragma test expect_ir(R"(instantiate_fun(lit("target_type" : <ref<int<4>,f,f,qualified>>(ptr<(IMP_TemplateClass<ref<int<4>,f,f,qualified>>) -> unit,t,f>) -> unit), lit("IMP_dependentFunPointerParam" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>(ptr<(IMP_TemplateClass<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>) -> unit,t,f>) -> unit))(ptr_of_function(instantiate_fun(lit("target_type" : (IMP_TemplateClass<ref<int<4>,f,f,qualified>>) -> unit), lit("IMP_modifier" : (IMP_TemplateClass<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>) -> unit)))))")
	...
	#pragma test expect_ir(R"(instantiate_fun(lit("target_type" : (int<4>) -> int<4>), lit("IMP_variadicTemplateFun" : ('T_0_0) -> 'T_0_0))(0))")
	variadicTemplateFun(0);

	#pragma test expect_ir(R"(instantiate_fun(lit("target_type" : (int<4>, int<4>) -> int<4>), lit("IMP_variadicTemplateFun" : ('T_0_0, 'V_T_0_1...) -> 'T_0_0))(0, 1))")
	variadicTemplateFun(0, 1);

	#pragma test expect_ir(R"(instantiate_fun(lit("target_type" : (int<4>, int<4>, real<8>, uint<4>) -> int<4>), lit("IMP_variadicTemplateFun" : ('T_0_0, 'V_T_0_1...) -> 'T_0_0))(0, 1, 2.0E+0, 90u))")
	variadicTemplateFun(0, 1, 2.0, 90u);

	#pragma test expect_ir(R"(instantiate_fun(lit("target_type" : <ref<real<8>,f,f,qualified>, 0, 1, 2>(real<8>) -> int<4>), lit("IMP_variadicNonTypeTemplateFun" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>, 'V_T_0_1...>('T_0_0) -> int<4>))(0.0E+0))")
	...
	#pragma test expect_ir(R"(instantiate_fun(lit("target_type" : <IMP_TemplateWithMethod<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>, IMP_TemplateClass<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>>() -> unit), lit("IMP_variadicTemplateTemplateFun" : <'V_T_T_0_0...<>>() -> unit))())")
