...
int main() {
	...
	#pragma test expect_ir(R"(
		...
		def struct IMP_range_splitter_struct_space_S {
			static split_returns_std_colon__colon_pair_lt_S_comma__space_S_gt_ = function () -> IMP_std_colon__colon_pair<ref<IMP_S,f,f,qualified>,ref<IMP_S,f,f,qualified>> {
		...
		{
			IMP_constSRefConsumer(ref_kind_cast(ref_member_access(IMP_range_splitter_struct_space_S__static__split_returns_std_colon__colon_pair_lt_S_comma__space_S_gt_() materialize, lit("first"), type_lit(IMP_S)), type_lit(cpp_ref)));
		}
	)")
	{
		constSRefConsumer(range_splitter<S>::split().first);
	}
}
