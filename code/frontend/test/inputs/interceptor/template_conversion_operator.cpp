...
int main() {
	...
	#pragma test expect_ir(R"({
		...
		var ref<IMP_TemplateClass<ref<int<4>,f,f,qualified>>,f,f,plain> v2 = ref_cast(lit("IMP_TemplateClass::ctor" : IMP_TemplateClass<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>::(ref<IMP_TemplateClass<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>,f,f,cpp_rref>))(ref_temp(type_lit(IMP_TemplateClass<ref<int<4>,f,f,qualified>>)), ref_kind_cast(lit("IMP_ConvertibleToTemplateClass::IMP__conversion_operator_TemplateClass_lt_int_gt_" : IMP_ConvertibleToTemplateClass::() -> IMP_TemplateClass<ref<int<4>,f,f,qualified>>)(v0) materialize , type_lit(cpp_rref))), type_lit(f), type_lit(f), type_lit(cpp_rref));
