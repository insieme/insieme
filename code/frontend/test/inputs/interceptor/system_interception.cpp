...
int main() {
	...
	#pragma test expect_ir(R"({
		var ref<IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>,f,f,plain> v0 = type_instantiation(type_lit(IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>::()), lit("IMP_std_colon__colon_vector::ctor" : IMP_std_colon__colon_vector<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::()))(ref_decl(type_lit(ref<IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>,f,f,plain>)));
		type_instantiation(type_lit(IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>::(ref<int<4>,f,f,cpp_rref>) -> unit), lit("IMP_std_colon__colon_vector::IMP_push_back" : IMP_std_colon__colon_vector<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::(ref<'T_0_0,f,f,cpp_rref>) -> unit))(v0, 0);
		var ref<IMP_std_colon__colon_vector<ref<real<8>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<real<8>,f,f,qualified>>,f,f,qualified>>,f,f,plain> v1 = type_instantiation(type_lit(IMP_std_colon__colon_vector<ref<real<8>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<real<8>,f,f,qualified>>,f,f,qualified>>::()), lit("IMP_std_colon__colon_vector::ctor" : IMP_std_colon__colon_vector<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::()))(ref_decl(type_lit(ref<IMP_std_colon__colon_vector<ref<real<8>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<real<8>,f,f,qualified>>,f,f,qualified>>,f,f,plain>)));
		type_instantiation(type_lit(IMP_std_colon__colon_vector<ref<real<8>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<real<8>,f,f,qualified>>,f,f,qualified>>::(ref<real<8>,f,f,cpp_rref>) -> unit), lit("IMP_std_colon__colon_vector::IMP_push_back" : IMP_std_colon__colon_vector<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::(ref<'T_0_0,f,f,cpp_rref>) -> unit))(v1, 1.0E+0);
	})")
	{
		std::vector<int> v1;
		v1.push_back(0);
	...
	#pragma test expect_ir(R"({
		type_instantiation(type_lit((ref<IMP_std_colon__colon_basic_ostream<ref<char,f,f,qualified>,ref<IMP_std_colon__colon_char_traits<ref<char,f,f,qualified>>,f,f,qualified>>,f,f,cpp_ref>, ptr<char,t,f>) -> ref<IMP_std_colon__colon_basic_ostream<ref<char,f,f,qualified>,ref<IMP_std_colon__colon_char_traits<ref<char,f,f,qualified>>,f,f,qualified>>,f,f,cpp_ref>), lit("IMP_std_colon__colon__operator_lshift_" : (ref<IMP_std_colon__colon_basic_ostream<char,'T_0_0>,f,f,cpp_ref>, ptr<char,t,f>) -> ref<IMP_std_colon__colon_basic_ostream<char,'T_0_0>,f,f,cpp_ref>))(ref_kind_cast(lit("IMP_std_colon__colon_cout" : ref<IMP_std_colon__colon_basic_ostream<ref<char,f,f,qualified>,ref<IMP_std_colon__colon_char_traits<ref<char,f,f,qualified>>,f,f,qualified>>,f,f,plain>), type_lit(cpp_ref)), ptr_from_array(lit(""Test"" : ref<array<char,5u>,t,f,plain>))) materialize ;
	})")
	{
		std::cout << "Test";
	}
	...
	#pragma test expect_ir(R"(
		...
		{
			var ref<IMP_std_colon__colon_vector<ref<IMP_Trivial,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<IMP_Trivial,f,f,qualified>>,f,f,qualified>>,f,f,plain> v0 = type_instantiation(type_lit(IMP_std_colon__colon_vector<ref<IMP_Trivial,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<IMP_Trivial,f,f,qualified>>,f,f,qualified>>::()), lit("IMP_std_colon__colon_vector::ctor" : IMP_std_colon__colon_vector<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::()))(ref_decl(type_lit(ref<IMP_std_colon__colon_vector<ref<IMP_Trivial,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<IMP_Trivial,f,f,qualified>>,f,f,qualified>>,f,f,plain>)));
		}
	)")
	{
	...
	#pragma test expect_ir(R"({
		var ref<IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>,f,f,plain> v0 = type_instantiation(type_lit(IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>::()), lit("IMP_std_colon__colon_vector::ctor" : IMP_std_colon__colon_vector<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::()))(ref_decl(type_lit(ref<IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>,f,f,plain>)));
		type_instantiation(type_lit(const IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>::() -> uint<8>), lit("IMP_std_colon__colon_vector::IMP_size" : const IMP_std_colon__colon_vector<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::() -> uint<8>))(v0);
	})")
	{
		std::vector<int> a;
		a.size();
	...
	#pragma test expect_ir(R"({
		var ref<IMP_std_colon__colon_vector<ref<bool,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<bool,f,f,qualified>>,f,f,qualified>>,f,f,plain> v0 = type_instantiation(type_lit(IMP_std_colon__colon_vector<ref<bool,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<bool,f,f,qualified>>,f,f,qualified>>::()), lit("IMP_std_colon__colon_vector::ctor" : IMP_std_colon__colon_vector<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::()))(ref_decl(type_lit(ref<IMP_std_colon__colon_vector<ref<bool,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<bool,f,f,qualified>>,f,f,qualified>>,f,f,plain>)));
	})")
	{
		std::vector<bool> b;
	}
	...
	#pragma test expect_ir(R"(
		...
		{
			type_instantiation(type_lit(<ref<IMP_OtherTrivial,f,f,qualified>>() -> IMP_std_colon__colon_shared_ptr<ref<IMP_OtherTrivial,f,f,qualified>>), lit("IMP_std_colon__colon_make_shared" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>, 'V_T_0_1...>('V_T_0_1...) -> IMP_std_colon__colon_shared_ptr<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>))() materialize;
		}
	)")
	{
	...
	#pragma test expect_ir(R"(
		...
		def struct IMP_InitListTest {
			...
			ctor function () {
				type_instantiation(type_lit(IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>::()), lit("IMP_std_colon__colon_vector::ctor" : IMP_std_colon__colon_vector<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::()))((this).v);
			}
		};
		{
	...
	#pragma test expect_ir(R"(
		 var ref<IMP_std_colon__colon_pair<ref<int<4>,f,f,qualified>,ref<bool,f,f,qualified>>,f,f,plain> v0 =
			ref_cast(type_instantiation(type_lit((ref<int<4>,f,f,cpp_rref>, ref<bool,f,f,cpp_rref>) -> IMP_std_colon__colon_pair<ref<int<4>,f,f,qualified>,ref<bool,f,f,qualified>>),
				lit("IMP_std_colon__colon_make_pair" : (ref<'T_0_0,f,f,cpp_rref>, ref<'T_0_1,f,f,cpp_rref>) -> IMP_std_colon__colon_pair<'IMP_typename_space___decay_and_strip_lt__T1_gt__colon__colon___type,'IMP_typename_space___decay_and_strip_lt__T2_gt__colon__colon___type>))(12, true) materialize , type_lit(f), type_lit(f), type_lit(cpp_rref));
	)")
	...
	#pragma test expect_ir(R"({
		var ref<IMP_std_colon__colon_function<ref<(int<4>) -> int<4>,f,f,qualified>>,f,f,plain> v0 =
				type_instantiation(type_lit(IMP_std_colon__colon_function<ref<(int<4>)->int<4>,f,f,qualified>>::()),
		...
		type_instantiation(type_lit(const IMP_std_colon__colon_function<ref<(int<4>)->int<4>,f,f,qualified>>::(int<4>) -> int<4>),
	...
	#pragma test expect_ir(R"({
		var ref<ptr<IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>>,f,f,plain> v0 = ptr_from_ref(type_instantiation(type_lit(IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>::()), lit("IMP_std_colon__colon_vector::ctor" : IMP_std_colon__colon_vector<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::()))(ref_new(type_lit(IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>))));
	...
	#pragma test expect_ir(R"({
		var ref<IMP_std_colon__colon___cxx11_colon__colon_basic_string<ref<char,f,f,qualified>,ref<IMP_std_colon__colon_char_traits<ref<char,f,f,qualified>>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<char,f,f,qualified>>,f,f,qualified>>,f,f,plain> v0 = type_instantiation(type_lit(IMP_std_colon__colon___cxx11_colon__colon_basic_string<ref<char,f,f,qualified>,ref<IMP_std_colon__colon_char_traits<ref<char,f,f,qualified>>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<char,f,f,qualified>>,f,f,qualified>>::()), lit("IMP_std_colon__colon___cxx11_colon__colon_basic_string::ctor" : IMP_std_colon__colon___cxx11_colon__colon_basic_string<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>,ref<'T_0_2,'T_0_2_a,'T_0_2_b,'T_0_2_c>>::()))(ref_decl(type_lit(ref<IMP_std_colon__colon___cxx11_colon__colon_basic_string<ref<char,f,f,qualified>,ref<IMP_std_colon__colon_char_traits<ref<char,f,f,qualified>>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<char,f,f,qualified>>,f,f,qualified>>,f,f,plain>)));
    var ref<IMP_std_colon__colon___cxx11_colon__colon_basic_stringstream<ref<char,f,f,qualified>,ref<IMP_std_colon__colon_char_traits<ref<char,f,f,qualified>>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<char,f,f,qualified>>,f,f,qualified>>,f,f,plain> v1 = type_instantiation(type_lit(IMP_std_colon__colon___cxx11_colon__colon_basic_stringstream<ref<char,f,f,qualified>,ref<IMP_std_colon__colon_char_traits<ref<char,f,f,qualified>>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<char,f,f,qualified>>,f,f,qualified>>::(ref<IMP_std_colon__colon___cxx11_colon__colon_basic_string<ref<char,f,f,qualified>,ref<IMP_std_colon__colon_char_traits<ref<char,f,f,qualified>>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<char,f,f,qualified>>,f,f,qualified>>,t,f,cpp_ref>, (type<enum_def<IMP_std_colon__colon__Ios_Openmode,int<4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_app,1>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ate,2>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_bin,4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_in,8>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_out,16>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_trunc,32>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ios_openmode_end,65536>>>, int<4>))), lit("IMP_std_colon__colon___cxx11_colon__colon_basic_stringstream::ctor" : IMP_std_colon__colon___cxx11_colon__colon_basic_stringstream<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>,ref<'T_0_2,'T_0_2_a,'T_0_2_b,'T_0_2_c>>::(ref<IMP_std_colon__colon___cxx11_colon__colon_basic_string<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>,ref<'T_0_2,'T_0_2_a,'T_0_2_b,'T_0_2_c>>,t,f,cpp_ref>, (type<enum_def<IMP_std_colon__colon__Ios_Openmode,int<4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_app,1>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ate,2>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_bin,4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_in,8>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_out,16>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_trunc,32>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ios_openmode_end,65536>>>, int<4>))))(ref_decl(type_lit(ref<IMP_std_colon__colon___cxx11_colon__colon_basic_stringstream<ref<char,f,f,qualified>,ref<IMP_std_colon__colon_char_traits<ref<char,f,f,qualified>>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<char,f,f,qualified>>,f,f,qualified>>,f,f,plain>)), ref_kind_cast(v0, type_lit(cpp_ref)), lit("IMP_std_colon__colon__operator_or_" : ((type<enum_def<IMP_std_colon__colon__Ios_Openmode,int<4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_app,1>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ate,2>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_bin,4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_in,8>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_out,16>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_trunc,32>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ios_openmode_end,65536>>>, int<4>), (type<enum_def<IMP_std_colon__colon__Ios_Openmode,int<4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_app,1>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ate,2>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_bin,4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_in,8>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_out,16>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_trunc,32>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ios_openmode_end,65536>>>, int<4>)) -> (type<enum_def<IMP_std_colon__colon__Ios_Openmode,int<4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_app,1>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ate,2>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_bin,4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_in,8>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_out,16>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_trunc,32>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ios_openmode_end,65536>>>, int<4>))(*lit("IMP_std_colon__colon_ios_base_colon__colon_out" : ref<(type<enum_def<IMP_std_colon__colon__Ios_Openmode,int<4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_app,1>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ate,2>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_bin,4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_in,8>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_out,16>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_trunc,32>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ios_openmode_end,65536>>>, int<4>),t,f,plain>), *lit("IMP_std_colon__colon_ios_base_colon__colon_in" : ref<(type<enum_def<IMP_std_colon__colon__Ios_Openmode,int<4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_app,1>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ate,2>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_bin,4>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_in,8>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_out,16>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_trunc,32>,enum_entry<IMP_std_colon__colon__Ios_Openmode_colon__colon__S_ios_openmode_end,65536>>>, int<4>),t,f,plain>)));
	})")
	{
		std::string s;
