...
int main() {
	...
	#pragma test expect_ir(R"(
		...
		{
			instantiate(lit("target_type" : <ref<IMP_OtherTrivial,f,f,qualified>>() -> IMP_std_colon__colon_shared_ptr<ref<IMP_OtherTrivial,f,f,qualified>>), lit("IMP_std_colon__colon_make_shared" : <ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>, 'V_T_0_1...>('V_T_0_1...) -> IMP_std_colon__colon_shared_ptr<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>>))() materialize;
		}
	)")
	{
	...
	#pragma test expect_ir(R"(
		...
		def struct IMP_InitListTest {
			...
			ctor function () {
				instantiate(lit("target_type" : IMP_std_colon__colon_vector<ref<int<4>,f,f,qualified>,ref<IMP_std_colon__colon_allocator<ref<int<4>,f,f,qualified>>,f,f,qualified>>::()), lit("IMP_std_colon__colon_vector::ctor" : IMP_std_colon__colon_vector<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::()))((this).v);
			}
		};
		{
	...
	#pragma test expect_ir(R"(
		 var ref<IMP_std_colon__colon_pair<ref<int<4>,f,f,qualified>,ref<bool,f,f,qualified>>,f,f,plain> v0 =
			ref_cast(instantiate(lit("target_type" : (ref<int<4>,f,f,cpp_rref>, ref<bool,f,f,cpp_rref>) -> IMP_std_colon__colon_pair<ref<int<4>,f,f,qualified>,ref<bool,f,f,qualified>>),
	...
	#pragma test expect_ir(R"({
		var ref<IMP_std_colon__colon_function<ref<(int<4>) -> int<4>,f,f,qualified>>,f,f,plain> v0 =
				instantiate(lit("target_type" : IMP_std_colon__colon_function<ref<(int<4>)->int<4>,f,f,qualified>>::()),
		...
		instantiate(lit("target_type" : const IMP_std_colon__colon_function<ref<(int<4>)->int<4>,f,f,qualified>>::(int<4>) -> int<4>),
