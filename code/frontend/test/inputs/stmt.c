...
#pragma "recFun v16 { v16 = fun(int<4> v18) -> int<4> { return v17((v18-1)); }; v17 = fun(int<4> v19) -> int<4> { return v16((v19+1)); };}"
int f(int x) {
	return g(x-1);
}
...
void rec_function_call_test() {
	#pragma "recFun v16 { v16 = fun(int<4> v18) -> int<4> { return v17((v18-1)); }; v17 = fun(int<4> v19) -> int<4> { return v16((v19+1)); };}(10)"
	f(10);
}
