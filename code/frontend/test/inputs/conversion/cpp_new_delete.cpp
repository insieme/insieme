...
int main() {
	...
	#pragma test expect_ir(R"(
		...
		{
			var ref<int<4>,f,f,plain> v0 = 50;
			var ref<ptr<int<4>>,f,f,plain> v1 = new_arr_fun(num_cast(*v0+5, type_lit(uint<inf>)), ref_kind_cast(ref_temp_init(1), type_lit(cpp_ref)), ref_kind_cast(ref_temp_init(2), type_lit(cpp_ref)), ref_kind_cast(ref_temp_init(3), type_lit(cpp_ref)));
			ref_delete(ptr_to_array(*v1));
		}
	)")
	{
