...
int main() {
	...
	#pragma test expect_ir(R"(
		...
		};
		{
			...
			v6 = ptr_from_array(<ref<array<IMP_StructWithArray,2u>,f,f,plain>>(ref_temp(type_lit(array<IMP_StructWithArray,2u>))) {ref_cast(<ref<IMP_StructWithArray,f,f,plain>>(ref_temp(type_lit(IMP_StructWithArray))) {1, <ref<array<int<4>,2u>,f,f,plain>>(ref_decl(type_lit(ref<array<int<4>,2u>,f,f,plain>))) {2, 3}}, type_lit(f), type_lit(f), type_lit(cpp_rref)), ref_cast(<ref<IMP_StructWithArray,f,f,plain>>(ref_temp(type_lit(IMP_StructWithArray))) {4, <ref<array<int<4>,2u>,f,f,plain>>(ref_decl(type_lit(ref<array<int<4>,2u>,f,f,plain>))) {5, 6}}, type_lit(f), type_lit(f), type_lit(cpp_rref))});
		}
	)")
	{
