...
def struct IMP_AddOpTest {
	function IMP__operator_plus_ = (v0 : ref<IMP_AddOpTest,t,f,cpp_ref>) -> IMP_AddOpTest { 
		return ref_cast(IMP_AddOpTest::(ref_var(type_lit(IMP_AddOpTest))), type_lit(f), type_lit(f), type_lit(cpp_rref));
	}
};)"
...
def IMP__operator_plus_ = function (v0 : ref<IMP_AddOpExternTest,t,f,cpp_ref>, v1 : ref<IMP_AddOpExternTest,t,f,cpp_ref>) -> IMP_AddOpExternTest {
	return ref_cast(IMP_AddOpExternTest::(ref_var(type_lit(IMP_AddOpExternTest))), type_lit(f), type_lit(f), type_lit(cpp_rref));
};
)"
...
int main() {
	...
	#pragma test expect_ir(ADDOPTEST_IR,R"( {
		var ref<IMP_AddOpTest,f,f,plain> v0 = IMP_AddOpTest::(ref_var(type_lit(IMP_AddOpTest)));
		var ref<IMP_AddOpTest,f,f,plain> v1 = IMP_AddOpTest::(ref_var(type_lit(IMP_AddOpTest)));
	...
	#pragma test expect_ir(ADDOPEXTERNTEST_IR,R"( {
		var ref<IMP_AddOpExternTest,f,f,plain> v0 = IMP_AddOpExternTest::(ref_var(type_lit(IMP_AddOpExternTest)));
		var ref<IMP_AddOpExternTest,f,f,plain> v1 = IMP_AddOpExternTest::(ref_var(type_lit(IMP_AddOpExternTest)));
