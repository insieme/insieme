...
int main() {
	...
	#pragma test expect_ir(R"({
		...
		var ref<int<4>,f,f,plain> v1 = 2;
		var ref<int<4>,f,f,cpp_ref> v2 = ref_kind_cast(v0, type_lit(cpp_ref));
		var ref<int<4>,f,f,cpp_ref> v3 = ref_kind_cast(v1, type_lit(cpp_ref));
	...
	#pragma test expect_ir(R"({
		...
		var ref<int<4>,f,f,plain> v1 = 2;
		var ref<int<4>,f,f,cpp_ref> v2 = ref_kind_cast(v0, type_lit(cpp_ref));
		var ref<int<4>,t,f,cpp_ref> v3 = ref_kind_cast(v1, type_lit(cpp_ref));
	...
	#pragma test expect_ir(R"({
		...
		var ref<real<8>,f,f,plain> v1 = num_cast(2, type_lit(real<8>));
		var ref<int<4>,f,f,cpp_ref> v2 = ref_kind_cast(v0, type_lit(cpp_ref));
		var ref<real<8>,f,f,cpp_ref> v3 = ref_kind_cast(v1, type_lit(cpp_ref));
		var ref<real<8>,f,f,plain> v4 = true?num_cast(*v2, type_lit(real<8>)):*v3;
	})")
	{
		int i = 1;
	...
	#pragma test expect_ir(R"({
		...
		var ref<real<8>,f,f,plain> v1 = num_cast(2, type_lit(real<8>));
		var ref<int<4>,f,f,cpp_ref> v2 = ref_kind_cast(v0, type_lit(cpp_ref));
		var ref<real<8>,t,f,cpp_ref> v3 = ref_kind_cast(v1, type_lit(cpp_ref));
    var ref<real<8>,f,f,plain> v4 = true?num_cast(*v2, type_lit(real<8>)):*v3;
	})")
	{
		int i = 1;
