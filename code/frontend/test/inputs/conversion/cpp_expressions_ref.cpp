...
int main() {
	...
	#pragma test expect_ir(R"({
		var ref<int<4>,f,f,plain> v0 = ref_decl(type_lit(ref<int<4>,f,f,plain>));
		var ref<int<4>,t,f,cpp_ref> v1 = ref_kind_cast(v0, type_lit(cpp_ref));
	...
	#pragma test expect_ir(R"({
		...
		var ref<int<4>,f,f,cpp_ref> v2 = ref_kind_cast(v0, type_lit(cpp_ref));
		var ref<real<4>,f,f,cpp_ref> v3 = ref_kind_cast(v1, type_lit(cpp_ref));
	...
	#pragma test expect_ir(R"({
		...
		var ref<ptr<int<4>>,f,f,cpp_ref> v1 = ref_kind_cast(v0, type_lit(cpp_ref));
		ptr_to_ref(*v1);
	})")
	{
		intPtr a;
	...
	#pragma test expect_ir(R"({
		var ref<ptr<int<4>>,f,f,plain> v0 = ref_decl(type_lit(ref<ptr<int<4>>,f,f,plain>));
		var ref<ptr<int<4>>,t,f,cpp_ref> v1 = ref_kind_cast(v0, type_lit(cpp_ref));
		ptr_to_ref(*v1);
	})")
	{
		intPtr a;
	...
	#pragma test expect_ir(R"({
		...
		var ref<ptr<int<4>,t,f>,t,f,cpp_ref> v1 = ref_kind_cast(v0, type_lit(cpp_ref));
		ptr_to_ref(*v1);
	})")
	{
		constIntPtr a;
