...
int main() {
	...
	#pragma test expect_ir("REGEX", R"(decl ref<__insieme_enum<\w+enum_t\w+,Bla,Alb>,f,f,plain> v0 = .*)")
	enum_t enu;
	
	#pragma test expect_ir("REGEX", R"(decl ref<__insieme_enum<\w+,XY,ZR>,f,f,plain> v0 = .*)")
	enum { XY, ZR } bla; 
	...
	#pragma test expect_ir("REGEX", R"(decl ref<struct \w+swi_s\w+ \{int<4> i\},f,f,plain> v0 = .*)")
	swi_t swi_1;
	#pragma test expect_ir("REGEX", R"(decl ref<struct \w+swi_s\w+ \{int<4> i\},f,f,plain> v0 = .*)")
	struct swi_s swi_2; 
