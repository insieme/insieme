...
int main(int argc, char** argv) {
	// basic types
	{
	#pragma test expected "decl ref<int<1>> v0 = ( var(undefined(type<int<1>>)))"
		cl_char var1;
		#pragma test expected "decl ref<uint<1>> v0 = ( var(undefined(type<uint<1>>)))"
		cl_uchar var2;
		#pragma test expected "decl ref<int<2>> v0 = ( var(undefined(type<int<2>>)))"
		cl_short var3;
		#pragma test expected "decl ref<uint<2>> v0 = ( var(undefined(type<uint<2>>)))"
		cl_ushort var4;
		#pragma test expected "decl ref<int<4>> v0 = ( var(undefined(type<int<4>>)))"
		cl_int var5;
		...
		cl_long var7;
		#pragma test expected "decl ref<uint<8>> v0 = ( var(undefined(type<uint<8>>)))"
		cl_ulong var8;
		#pragma test expected "decl ref<uint<2>> v0 = ( var(undefined(type<uint<2>>)))"
		cl_half var9;
	...
	{
	#pragma test expected "decl ref<int<1>> v0 = ( var(1))"
		cl_char var1 = 1;
		#pragma test expected "decl ref<uint<1>> v0 = ( var(1u))"
		cl_uchar var2 = 1;
		#pragma test expected "decl ref<int<2>> v0 = ( var(1))"
		cl_short var3 = 1;
		#pragma test expected "decl ref<uint<2>> v0 = ( var(1u))"
		cl_ushort var4 = 1;
		#pragma test expected "decl ref<int<4>> v0 = ( var(1))"
		cl_int var5 = 1;
		#pragma test expected "decl ref<uint<4>> v0 = ( var(1u))"
		cl_uint var6 = 1;
		#pragma test expected "decl ref<int<8>> v0 = ( var(1l))"
		cl_long var7 = 1;
		#pragma test expected "decl ref<uint<8>> v0 = ( var(1ul))"
		cl_ulong var8 = 1;
		#pragma test expected "decl ref<uint<2>> v0 = ( var(1u))"
		cl_half var9 = 1;
		#pragma test expected "decl ref<real<4>> v0 = ( var(1.0f))"
		cl_float var10 = 1;
		#pragma test expected "decl ref<real<8>> v0 = ( var(1.0))"
		cl_double var11 = 1;
	}
	...
	#pragma test expected                                                                                                                                      \
		...
		#pragma test expected "((ref_vector_to_ref_array((v100->s))&[0u]) := 1)"
		initVar.s[0] = 1;

		#pragma test expected "(((v100->__m1)->x) := 1)"
		initVar.x = 1;

		#pragma test expected "(((v100->__m2)->s0) := 1)"
		initVar.s0 = 1;

		#pragma test expected "(((v100->__m3)->lo) := 1)"
		initVar.lo = 1;

		#pragma test expected "(v100 := union{AP(s):=[1, 2]})"
	...
	#pragma test expected                                                                                                                                      \
		...
		#pragma test expected "(((v100->__m3)->lo) := union{AP(s):=[1, 2]})"
		initVar.lo = (cl_short2){1, 2};

		#pragma test expected "(v100 := union{AP(s):=[1, 2, 3, 4]})"
