...
core::TypePtr Converter::TypeConverter::VisitBuiltinType(const BuiltinType* buldInTy) {
	...
	case BuiltinType::Char16:
		return gen.getWChar16(); //TODO c++11 specific builtin
	case BuiltinType::Char32:
		return gen.getWChar32(); //TODO c++11 specific builtin
	case BuiltinType::Char_S:
		return gen.getChar();
	case BuiltinType::SChar:
		return gen.getInt1(); //Signed char, remember: char, unsigned char, signed char are distinct types
	...
	case BuiltinType::Double:
		return gen.getDouble();
	case BuiltinType::LongDouble:
		return gen.getLongDouble();
		
	// not supported types
	case BuiltinType::NullPtr:
		return builder.typeVariable("nullptr_t"); //TODO c++11 specific builtin type for nullptr literal
