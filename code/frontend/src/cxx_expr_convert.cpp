...
//---------------------------------------------------------------------------------------------------------------------
class CXXConversionFactory::CXXClangExprConverter: public ConversionFactory::ClangExprConverter {

public:

	cpp::TemporaryHandler tempHandler;

	CXXClangExprConverter(CXXConversionFactory& convFact, Program& program) :
		ClangExprConverter(convFact, program),
		tempHandler(&convFact) {
		funcDepGraph = utils::FunctionDependencyGraph(program.getClangIndexer(), utils::CXXCallExprVisitor(program.getClangIndexer()));
	}
	virtual ~CXXClangExprConverter();
...
CXXConversionFactory::CXXClangExprConverter*
CXXConversionFactory::makeExprConvert(CXXConversionFactory& fact, Program& program) {
	return new CXXClangExprConverter(fact, program);
}

void CXXConversionFactory::cleanExprConvert(CXXConversionFactory::CXXClangExprConverter* exprConv) {
	delete exprConv;
}

core::ExpressionPtr CXXConversionFactory::convertExpr(const clang::Expr* expr) const {
