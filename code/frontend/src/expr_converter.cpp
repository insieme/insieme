...
//	CallExprVisitor::CallGraph&& graph = callExprVis.getCallGraph(func);
	...
	CallExprVisitor::CallGraph&& graph = funcDepGraph.callExprVis.getCallGraph(func);
...
//---------------------------------------------------------------------------------------------------------------------
core::ExpressionPtr ConversionFactory::ClangExprConverter::wrapVariable(clang::Expr* expr) {
...
core::ExpressionPtr ConversionFactory::ClangExprConverter::asLValue(const core::ExpressionPtr& value) {
...
core::ExpressionPtr ConversionFactory::ClangExprConverter::asRValue(const core::ExpressionPtr& value) {
...
ExpressionList ConversionFactory::ClangExprConverter::getFunctionArguments(const core::IRBuilder& builder, ClangExprTy* callExpr,
...
ConversionFactory::ClangExprConverter::ClangExprConverter(ConversionFactory& convFact, Program& program) :
		convFact(convFact),
		ctx(convFact.ctx),
		funcDepGraph(program.getClangIndexer())
	{
}
ConversionFactory::ClangExprConverter::~ClangExprConverter() {};

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//								INTEGER LITERAL
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitIntegerLiteral(clang::IntegerLiteral* intLit) {
...
//								FLOATING LITERAL
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitFloatingLiteral(clang::FloatingLiteral* floatLit) {
...
//								CHARACTER LITERAL
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitCharacterLiteral(CharacterLiteral* charLit) {
...
//								STRING LITERAL
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitStringLiteral(clang::StringLiteral* stringLit) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitParenExpr(clang::ParenExpr* parExpr) {
	core::ExpressionPtr retExpr;
...
// of a pointer).
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitGNUNullExpr(clang::GNUNullExpr* nullExpr) {
	const core::lang::BasicGenerator& gen = convFact.mgr.getLangBasic();
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitImplicitCastExpr(clang::ImplicitCastExpr* castExpr) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitExplicitCastExpr(clang::ExplicitCastExpr* castExpr) {
	START_LOG_EXPR_CONVERSION(castExpr);
...
//								CAST EXPRESSION
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitCastExpr(clang::CastExpr* castExpr) {
	START_LOG_EXPR_CONVERSION(castExpr);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitCallExpr(clang::CallExpr* callExpr) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitPredefinedExpr(clang::PredefinedExpr* preExpr) {
	const core::lang::BasicGenerator& gen = convFact.mgr.getLangBasic();
...
// (OpenCL 1.1 6.11.12).
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitUnaryExprOrTypeTraitExpr(clang::UnaryExprOrTypeTraitExpr* expr) {
	START_LOG_EXPR_CONVERSION(expr);
	core::ExpressionPtr irNode;
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitMemberExpr(clang::MemberExpr* membExpr) {
...
//							BINARY OPERATOR
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitBinaryOperator(clang::BinaryOperator* binOp) {
...
//							UNARY OPERATOR
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitUnaryOperator(clang::UnaryOperator *unOp) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitConditionalOperator(clang::ConditionalOperator* condOp) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitArraySubscriptExpr(clang::ArraySubscriptExpr* arraySubExpr) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitExtVectorElementExpr(ExtVectorElementExpr* vecElemExpr) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitDeclRefExpr(clang::DeclRefExpr* declRef) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitInitListExpr(clang::InitListExpr* initList) {
...
//		((int [3]){1,2,3})[2]  -> 2
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::VisitCompoundLiteralExpr(clang::CompoundLiteralExpr* compLitExpr) {
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr ConversionFactory::ClangExprConverter::Visit(clang::Expr* expr) {
...
//---------------------------------------------------------------------------------------------------------------------
//										CLANG EXT EXPRESSION CONVERTER
//---------------------------------------------------------------------------------------------------------------------
CXXConversionFactory::CXXExtExprConverter::CXXExtExprConverter(CXXConversionFactory& convFact, Program& program) :
	ClangExprConverter(convFact, program),
	convFact(convFact),
	tempHandler(&convFact) {
}
CXXConversionFactory::CXXExtExprConverter::~CXXExtExprConverter() {};

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//						  IMPLICIT CAST EXPRESSION
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr CXXConversionFactory::CXXExtExprConverter::VisitImplicitCastExpr(clang::ImplicitCastExpr* castExpr) {
	START_LOG_EXPR_CONVERSION(castExpr);
	const core::IRBuilder& builder = convFact.builder;
...
//						EXPLICIT CAST EXPRESSION
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr CXXConversionFactory::CXXExtExprConverter::VisitExplicitCastExpr(clang::ExplicitCastExpr* castExpr) {
	START_LOG_EXPR_CONVERSION(castExpr);
...
//							FUNCTION CALL EXPRESSION
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr CXXConversionFactory::CXXExtExprConverter::VisitCallExpr(clang::CallExpr* callExpr) {
...
//							VAR DECLARATION REFERENCE
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
core::ExpressionPtr CXXConversionFactory::CXXExtExprConverter::VisitDeclRefExpr(clang::DeclRefExpr* declRef) {
	START_LOG_EXPR_CONVERSION(declRef);
...
CXXConversionFactory::CXXExprConverter::CXXExprConverter(CXXConversionFactory& cxxConvFact, Program& program) :
...
CXXConversionFactory::CXXExprConverter::~CXXExprConverter() {}
