...
//
//
//	//check if all vars used in condExpr are readonly (we dont modify the bonduaries of a for loop... that is baaaad
...
//	const clang::VarDecl* getInductionDecl()			  const { return loopHelper.inductionDecl; }
//	const insieme::core::VariablePtr getInductionVar() 	  const { return loopHelper.inductionVar; }
//	const insieme::core::ExpressionPtr getInductionExpr() const { return loopHelper.inductionExpr; }
//
//
...
//
//	insieme::core::ExpressionPtr getInit() const { return loopHelper.initValue; }
//	insieme::core::ExpressionPtr getEnd()  const { return loopHelper.endValue; }
...
//
//		// spetial handeling of parameters, clean cache to allow redefinition
//		if(llvm::isa<clang::ParmVarDecl> (iv)){
...
//		std::cout << "incr: " << incExpr << std::endl;
//		std::cout << "condExp: " << condExpr << std::endl;
//
