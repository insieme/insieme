...
public:
	 ...
	 */
	PcaSeparateExt(const std::string& myDbPath, size_t nInFeatures, size_t nOutFeatures, std::string manglingPostfix = "")
	 ...
	 * @param manglingPostfix a postfix that will be added to every feature name in order to distinguish this PCs from others
	 */
	PcaSeparateExt(const std::string& myDbPath, double toBeCovered = 99.0, std::string manglingPostfix = "")
