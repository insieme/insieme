...
private:
	...
	const Entry& addType(const c_ast::PrimitiveTypePtr& type) {
		...
		case c_ast::PrimitiveType::Void:
			kind = "IRT_T_VOID";
			break;
		case c_ast::PrimitiveType::Bool:
			kind = "IRT_T_BOOL";
			break;
		case c_ast::PrimitiveType::Char:
			kind = "IRT_T_CHAR";
			break;
		case c_ast::PrimitiveType::Int8:
			kind = "IRT_T_INT8";
			break;
		case c_ast::PrimitiveType::Int16:
			kind = "IRT_T_INT16";
			break;
		case c_ast::PrimitiveType::Int32:
			kind = "IRT_T_INT32";
			break;
		case c_ast::PrimitiveType::Int64:
			kind = "IRT_T_INT64";
			break;
		case c_ast::PrimitiveType::Int128:
			kind = "IRT_T_INT128";
			break;
		case c_ast::PrimitiveType::UInt8:
			kind = "IRT_T_UINT8";
			break;
		case c_ast::PrimitiveType::UInt16:
			kind = "IRT_T_UINT16";
			break;
		case c_ast::PrimitiveType::UInt32:
			kind = "IRT_T_UINT32";
			break;
		case c_ast::PrimitiveType::UInt64:
			kind = "IRT_T_UINT64";
			break;
		case c_ast::PrimitiveType::UInt128:
			kind = "IRT_T_UINT128";
			break;
		case c_ast::PrimitiveType::Float:
			kind = "IRT_T_REAL32";
			break;
		case c_ast::PrimitiveType::Double:
			kind = "IRT_T_REAL64";
			break;
		case c_ast::PrimitiveType::LongLong:
			kind = "IRT_T_INT64";
			break;
		case c_ast::PrimitiveType::ULongLong:
			kind = "IRT_T_UINT64";
			break;
		}
...
unsigned MetaInfoTable::registerMetaInfoFor(const core::NodePtr& node) {
	...
	for(const auto& cur : node.getAnnotations()) {
		...
		if(!annotations::isMetaInfo(cur.second)) {
			continue;
		}
