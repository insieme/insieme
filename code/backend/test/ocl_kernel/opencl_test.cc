...
TEST(ocl_hostKernel, baseTest) {
	...
	CommandLineOptions::IncludePaths.push_back(std::string("/home/klaus/insieme/test/ocl/n_body"));
	...
	prog.addTranslationUnit("/home/klaus/insieme/test/ocl/n_body/n_body.c");
