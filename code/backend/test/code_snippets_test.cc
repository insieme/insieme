...
TEST(ForLoop, CountingUp) {
	...
	string code = toString(*converted);
	EXPECT_PRED2(containsSubString, code, "for (int32_t var_1 = 0; var_1 < 10; ++var_1) { };");
...
TEST(ForLoop, CountingDown) {
	...
	string code = toString(*converted);
	EXPECT_PRED2(containsSubString, code, "for (int32_t var_1 = 10; var_1 > 0; --var_1) { };");
...
TEST(ForLoop, CountingSomewhere) {
	core::NodeManager manager;
	core::IRBuilder builder(manager);
	...
	string code = toString(*converted);
	EXPECT_PRED2(containsSubString, code, "for (int32_t var_2 = 0, _up = s > 0; _up && var_2 < 10 || !_up && var_2 > 10; var_2+=s) { };");
...
TEST(ForLoop, Crazy) {
	...
	string code = toString(*converted);
	EXPECT_PRED2(containsSubString, code, "for (int32_t var_2 = s + 3, _end = s + 12, _step = s + 1, _up = s + 1 > 0; _up && var_2 < _end || !_up && var_2 > _end; var_2+=_step) { };");
