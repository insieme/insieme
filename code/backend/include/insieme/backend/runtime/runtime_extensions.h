...
namespace runtime {
	...
	public:
		 ...
		 * the pre-processing.
		 */
		const core::LiteralPtr initRuntime;

		/**
		 * The literal used to represent the init-context routine generated by the backend forming
		 * an entry point for the runtime.
		 */
		const core::LiteralPtr initContext;

		/**
		 * The literal used to represent the cleanup-context routine generated by the backend to
		 * provide a callback to the program when the resulting program is unloaded.
		 */
		const core::LiteralPtr cleanupContext;
		 ...
		 */
		const core::LiteralPtr registerWorkItem;
