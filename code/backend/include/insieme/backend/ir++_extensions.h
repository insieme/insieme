...
namespace backend {
	...
	/**
	 * This class offers a list of IR extensions required within the backend to encode
	 * IR++ constructs into C++ constructs. Such extensions include additional literals
	 * representing i.g. C++ cast operators.
	 */
