...
FloatLiteralPtr                floatLiteral(double value, const TypePtr& type) const;
FloatLiteralPtr                floatLiteral(const string& from, const TypePtr& type) const;
...
IntLiteralPtr                  intLiteral(int value, const TypePtr& type) const;
