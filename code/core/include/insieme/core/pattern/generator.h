...
namespace pattern {
	...
	template<typename target>
	inline ListGenerator forEach(const std::string& name, const std::shared_ptr<impl::MatchExpression<target>>& list, const std::shared_ptr<impl::MatchExpression<target>>& tree) {
