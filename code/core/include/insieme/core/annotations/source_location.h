...
namespace annotations {
	...
	class TextPosition :
			...
			public boost::equality_comparable<TextPosition>,
			public boost::less_than_comparable<TextPosition> {
	...
	public:
		 ...
		 */
		TextPosition(unsigned line, unsigned column)
	...
	public:
		 ...
		 */
		Location(const StringValuePtr& file, const TextPosition& start, const TextPosition& end)
			: file(file), start(start), end(end), shared(false) {
			//assert_le(start, end);
		}
