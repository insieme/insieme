...
namespace core {
	...
	template<typename V> class NodePathElement;
	template<typename V> class NodePath;
	...
	struct NodePathElementBase :
				public utils::Printable,
				public boost::equality_comparable<Derived>,
				public boost::less_than_comparable<Derived>
	{
	...
	public:
		...
		std::ostream& printToInternal(std::ostream& out) const {
			if (this->parent) {
				return out << *(this->parent) << "-" << this->index << "/" << value;
			}
	...
	struct NodePathElement<empty> : public NodePathElementBase<NodePathElement<empty>> {
		...
		std::ostream& printToInternal(std::ostream& out) const {
			if (this->parent) {
				return out << *(this->parent) << "-" << this->index;
			}
	...
	class NodePath :
			public utils::Printable,
			public boost::equality_comparable<NodePath<V>>,
			public boost::less_than_comparable<NodePath<V>>
	{
