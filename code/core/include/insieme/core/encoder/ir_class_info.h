 ...
 */
struct ClassMetaInfoConverter : public
	Converter<ClassMetaInfo, detail::create_class_info_type, detail::encode_class_info, detail::decode_class_info, detail::is_class_info> {};
