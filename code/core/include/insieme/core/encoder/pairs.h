 ...
 */
template<typename F, typename S, typename CF = Converter<F>, typename CS = Converter<S>>
struct PairConverter : public
	Converter<pair<F,S>, detail::create_pair_type<F,S,CF,CS>, detail::encode_pair<F,S,CF,CS>, detail::decode_pair<F,S,CF,CS>, detail::is_pair<F,S,CF,CS>> {};
