 ...
 */
template<typename K, typename V, typename CK = Converter<K>, typename CV = Converter<V>>
struct MapConverter : public
	Converter<map<K,V>, detail::create_map_type<K,V,CK,CV>, detail::encode_map<K,V,CK,CV>, detail::decode_map<K,V,CK,CV>, detail::is_map<K,V,CK,CV>> {};
