 ...
 */
template<typename K, typename V, typename CK = Converter<K>, typename CV = Converter<V>>
struct PointerMapConverter : public
	Converter<utils::map::PointerMap<K,V>, detail::create_map_type<K,V,CK,CV>, detail::encode_pointer_map<K,V,CK,CV>, detail::decode_pointer_map<K,V,CK,CV>, detail::is_map<K,V,CK,CV>> {};
