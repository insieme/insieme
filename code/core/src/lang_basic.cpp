...
ADD_TYPE(FunctionType, NO_ARGS_OP, (FunctionType(TypeList(), TYPE_UNIT_PTR)));

ADD_TYPE(TupleType, BOOL_SINGLE, TupleType(TYPE_BOOL_PTR));
ADD_TYPE(TupleType, BOOL_PAIR, TupleType(TYPE_BOOL_PTR,TYPE_BOOL_PTR));

ADD_TYPE(FunctionType, UNARY_BOOL_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_BOOL_PTR), TYPE_BOOL_PTR)));
ADD_TYPE(FunctionType, BINARY_BOOL_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_BOOL_PTR, TYPE_BOOL_PTR), TYPE_BOOL_PTR)));
...
ADD_TYPE(FunctionType, BINARY_INT_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_INT_GEN_PTR, TYPE_INT_GEN_PTR), TYPE_INT_GEN_PTR)));
...
ADD_TYPE(FunctionType, BINARY_UINT_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_UINT_GEN_PTR, TYPE_UINT_GEN_PTR), TYPE_UINT_GEN_PTR)));

// function type of job guards: (uint, uint) -> bool
ADD_TYPE(FunctionType, GUARD_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_UINT_GEN_PTR, TYPE_UINT_GEN_PTR), TYPE_BOOL_PTR)));
...
ADD_TYPE(FunctionType, BINARY_REAL_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_REAL_GEN_PTR, TYPE_REAL_GEN_PTR), TYPE_REAL_GEN_PTR)));
...
ADD_TYPE(FunctionType, COMPARISON_INT_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_INT_GEN_PTR, TYPE_INT_GEN_PTR), TYPE_BOOL_PTR)));
...
ADD_TYPE(FunctionType, COMPARISON_UINT_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_UINT_GEN_PTR, TYPE_UINT_GEN_PTR), TYPE_BOOL_PTR)));
...
ADD_TYPE(FunctionType, COMPARISON_REAL_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_REAL_GEN_PTR, TYPE_REAL_GEN_PTR), TYPE_BOOL_PTR)));
...
ADD_TYPE(FunctionType, BITWISE_INT_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_INT_GEN_PTR, TYPE_INT_GEN_PTR), TYPE_INT_GEN_PTR)));
...
ADD_TYPE(FunctionType, SHIFT_INT_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_INT_GEN_PTR, TYPE_INT_GEN_PTR), TYPE_INT_GEN_PTR)));

ADD_OP(INT_LEFT_SHIFT, TYPE_SHIFT_INT_OP_PTR, "int.leftShift");
ADD_OP(INT_RIGHT_SHIFT, TYPE_SHIFT_INT_OP_PTR, "int.rightShift");

ADD_TYPE(FunctionType, BITWISE_UINT_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_UINT_GEN_PTR, TYPE_UINT_GEN_PTR), TYPE_UINT_GEN_PTR)));
...
ADD_TYPE(FunctionType, SHIFT_UINT_OP, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_UINT_GEN_PTR, TYPE_UINT_GEN_PTR), TYPE_UINT_GEN_PTR)));
...
ADD_TYPE(FunctionType, OP_ALLOCATION, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_ALPHA_SINGLE_PTR), TYPE_REF_ALPHA_PTR)));

ADD_OP(REF_VAR, TYPE_OP_ALLOCATION_PTR, "ref.var");
ADD_OP(REF_NEW, TYPE_OP_ALLOCATION_PTR, "ref.new");

ADD_TYPE(FunctionType, OP_FREE, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_REF_ALPHA_PTR), TYPE_UNIT_PTR)));
ADD_OP(REF_DELETE, TYPE_OP_FREE_PTR, "ref.delete");

ADD_TYPE(FunctionType, OP_ASSIGN, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_REF_ALPHA_PTR), TYPE_UNIT_PTR)));
ADD_OP(REF_ASSIGN, TYPE_OP_ASSIGN_PTR, "ref.assign");

ADD_TYPE(FunctionType, OP_DEREF, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_REF_ALPHA_PTR), TYPE_ALPHA_PTR)));
...
ADD_TYPE(VectorType, VEC_UINT_GEN, (VectorType(TYPE_UINT_GEN_PTR, intParamN)));

// TODO: change sub-script type to unsigned integer
ADD_TYPE(TupleType, SUBSCRIPT_ARGUMENT, (TupleType(TYPE_ARRAY_GEN_PTR, TYPE_VEC_UINT_GEN_PTR)));
ADD_TYPE(FunctionType, OP_ARRAY_SUBSCRIPT, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_ARRAY_GEN_PTR, TYPE_VEC_UINT_GEN_PTR), TYPE_ALPHA_PTR)));

// SUBSCRIPT SINGLE
// TODO: change sub-script type to unsigned integer
ADD_TYPE(TupleType, SUBSCRIPT_SINGLE_ARGUMENT, (TupleType(TYPE_VEC_GEN_PTR, TYPE_UINT_GEN_PTR)));
ADD_TYPE(FunctionType, OP_ARRAY_SUBSCRIPT_SINGLE, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_VEC_GEN_PTR, TYPE_UINT_GEN_PTR), TYPE_ALPHA_PTR)));
...
ADD_TYPE(FunctionType, OP_ARRAY_LENGTH, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_ARRAY_GEN_PTR), TYPE_INT_GEN_PTR)));
...
ADD_TYPE(FunctionType, OP_VECTOR_INIT_UNIFORM, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_ALPHA_PTR), TYPE_VECTOR_GEN_PTR)))

ADD_OP(VECTOR_INIT_UNIFORM, TYPE_OP_VECTOR_INIT_UNIFORM, "vector.initUniform");

ADD_TYPE(FunctionType, OP_VECTOR_INIT_UNDEFINED, (FunctionType(TypeList(), TypeList(), TYPE_VECTOR_GEN_PTR)))
...
//ADD_TYPE(FunctionType, OP_SEND, (FunctionType(TypeList(), SINGLE_CHANNEL_GEN)));
//ADD_OP(SEND);
//ADD_OP(TRY_SEND);
//ADD_OP(RECV);
//ADD_OP(TRY_RECV);
...
// --- VAR_LIST packing ---
ADD_TYPE(FunctionType, OP_VAR_LIST_PACK, FunctionType(TypeList(), toVector<TypePtr>(TYPE_ALPHA_PTR), TYPE_VAR_LIST_PTR));
...
ADD_TYPE(FunctionType, OP_PARALLEL, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_UINT_4_PTR, TYPE_UINT_4_PTR, TYPE_JOB_PTR), TYPE_THREAD_GROUP_PTR)));
...
ADD_TYPE(FunctionType, OP_MERGE, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_THREAD_GROUP_PTR), TYPE_UNIT_PTR)));

ADD_OP(MERGE, TYPE_OP_MERGE_PTR ,"merge");

ADD_TYPE(FunctionType, OP_MERGE_ALL, (FunctionType(TypeList(), TypeList(), TYPE_UNIT_PTR)));
ADD_OP(MERGEALL, TYPE_OP_MERGE_ALL_PTR ,"mergeAll");

ADD_OP(BARRIER, TYPE_OP_MERGE_PTR ,"barrier");

ADD_TYPE(FunctionType, REDUCTION_FUNCTION, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_ALPHA_PTR, TYPE_ALPHA_PTR), TYPE_ALPHA_PTR)));
ADD_TYPE(FunctionType, OP_REDUCE, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_THREAD_GROUP_PTR, TYPE_REDUCTION_FUNCTION_PTR, TYPE_ALPHA_PTR, TYPE_ALPHA_PTR), TYPE_ALPHA_PTR)));
...
// --- if-then-else ---
ADD_TYPE(FunctionType, LAZY_GEN, (FunctionType(TypeList(), TypeList(), TYPE_ALPHA_PTR)));
ADD_TYPE(FunctionType, ITE_TYPE, (FunctionType(TypeList(), toVector<TypePtr>(TYPE_BOOL_PTR, TYPE_LAZY_GEN_PTR, TYPE_LAZY_GEN_PTR), TYPE_ALPHA_PTR)));
