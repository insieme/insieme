...
GenericTypePtr     ASTBuilder::genericType(const string& name, const vector<TypePtr>& typeParams, const vector<IntTypeParam>& intTypeParams, const TypePtr& baseType) { return GenericType::get(manager, name, typeParams, intTypeParams, baseType); }
