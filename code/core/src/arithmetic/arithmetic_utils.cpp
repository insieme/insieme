...
protected:
	...
	Constraint visitCallExpr(const CallExprPtr& call) {
		...
		case core::lang::BasicGenerator::Operator::Eq:
			return eq(a,b);
		case core::lang::BasicGenerator::Operator::Ne:
			return ne(a,b);
		case core::lang::BasicGenerator::Operator::Lt:
			return a < b;
		case core::lang::BasicGenerator::Operator::Le:
			return a <= b;
		case core::lang::BasicGenerator::Operator::Gt:
			return a > b;
		case core::lang::BasicGenerator::Operator::Ge:
			return a >= b;
		default:
			break; // ignore
		}
