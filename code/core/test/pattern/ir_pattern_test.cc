...
TEST(IRPattern, Structtypes) {
	...
	TreePatternPtr patternA = aT(irp::structType(*any));
	...
	TreePatternPtr patternB = aT(irp::refType(irp::arrayType(irp::structType(*any), atom(builder.concreteIntTypeParam(1)))));
