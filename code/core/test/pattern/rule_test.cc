...
TEST(Rule, VarDeref) {
	...
	EXPECT_EQ("ref_deref(rec v0.{v0=fun('a v1) {ref<'a> v2 = ref_alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc_stack); ref_assign(v2, v1); return v2;}}(1))",
	          toString(*b));
	EXPECT_EQ("ref_deref(rec v0.{v0=fun('a v1) {ref<'a> v2 = ref_alloc(rec v0.{v0=fun('a v1) {return type<'a>;}}(v1), memloc_heap); ref_assign(v2, v1); return v2;}}(1))",
	          toString(*c));
