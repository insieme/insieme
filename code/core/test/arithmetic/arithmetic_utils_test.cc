...
namespace arithmetic {
	...
	TEST(ConstraintTest, fromAndToIR) {
		...
		EXPECT_EQ("rec v0.{v0=fun(bool v1, (()=>bool) v2) {if(v1) {return v2();} else {}; return false;}}(bool_not(int_le(int_sub(v0, 1), 0)), bind(){rec "
		          "v0.{v0=fun(int<4> v1) {return bool_not(int_le(int_add(int_mul(-1, v1), 2), 0));}}(v0)})",
	...
	TEST(ArithmeticTest, PiecewiseToIRAndBack) {
		...
		EXPECT_EQ("rec v0.{v0=fun(bool v1, (()=>'b) v2, (()=>'b) v3) {if(v1) {return v2();} else {return v3();};}}(int_le(int_add(v1, v2), 0), bind(){rec "
		          "v0.{v0=fun(int<4> v1) {return int_add(int_mul(-1, v1), 7);}}(v1)}, rec v0.{v0=fun() {return 0;}})",
