...
namespace core {
	...
	TEST(NodeReplacer, ReplaceVariable) {
		...
		EXPECT_EQ("decl fun000 : (ref<uint<4>,f,f,plain>) -> uint<4>;\ndef fun000 = (v3 : ref<uint<4>,f,f,plain>) -> uint<4> {\n    return  *v3;\n};\n{\n    var ref<uint<4>,f,f,plain> v1 = ref_var_init(2u);\n    v1 = fun000( *v1);\n}", toString(printer::PrettyPrinter(stmt)));
		...
		EXPECT_EQ(  "decl fun000 : (ref<bool,f,f,plain>) -> bool;\ndef fun000 = (v39 : ref<bool,f,f,plain>) -> bool {\n    return  *v39;\n};\n{\n    var ref<bool,f,f,plain> v2 = ref_var_init(false);\n    v2 = fun000( *v2);\n}", toString(printer::PrettyPrinter(stmt2)));
