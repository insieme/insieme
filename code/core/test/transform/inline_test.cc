...
namespace transform {
	...
	TEST(Manipulation, MultiReturnInlineSimple) {
		...
		EXPECT_EQ("{{var ref<bool,f,f,plain> v0 = ref_var(false);{if(3<4) {{v1 = 3+2*6;v0 = true;};};if(! *v0) {{v1 = 3-6;v0 = true;};};};};}",
	...
	TEST(Manipulation, MultiReturnInlineLooping) {
		...
		EXPECT_EQ("{{var ref<bool,f,f,plain> v1 = ref_var(false);{if(3<4) {{v0 = 3+2*6;v1 = true;};};if(! *v1) {var ref<int<4>,f,f,plain> v2 = ref_var(3);while(true "
	...
	TEST(Manipulation, MultiReturnInlineUnit) {
		...
		EXPECT_EQ("{{var ref<bool,f,f,plain> v0 = ref_var(false);{if(3<4) {{v0 = true;};};if(! *v0) {var ref<int<4>,f,f,plain> v1 = ref_var(3);while(true && ! *v0) "
