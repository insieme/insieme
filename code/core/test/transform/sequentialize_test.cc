...
namespace transform {
	...
	TEST(Manipulation, SequentializeAtomic) {
		...
		EXPECT_EQ("{decl ref<int<4>> v0 = ( var(2));atomic_fetch_and_add(v0, 10);}",
		...
		EXPECT_EQ("{decl ref<int<4>> v0 = ( var(2));fun(ref<'a> v1, 'a v2) -> 'a {return fun(ref<'a> v1, 'a v2) -> 'a {decl 'a v3 = (v1);(v1 := gen_add((v1), "
