...
TEST(Manipulation, TryFixParameter_recursive) {
	...
	EXPECT_EQ("AP(rec v3.{v3=fun(int<4> v5) {if(int_eq(v5, 0)) {return unit;} else {}; ref_assign(global, int_add(ref_deref(global), v5)); v3(int_sub(v5, 1));}})" ,
	          toString(fixed));
	...
	EXPECT_NE(lambda, fixed);
	EXPECT_EQ("AP(rec v0.{v0=fun(ref<int<4>> v4) {if(int_eq(5, 0)) {return unit;} else {}; ref_assign(v4, int_add(ref_deref(v4), 5)); rec v3.{v3=fun(ref<int<4>> v4, int<4> v5) {if(int_eq(v5, 0)) {return unit;} else {}; ref_assign(v4, int_add(ref_deref(v4), v5)); v3(v4, int_sub(v5, 1));}}(v4, int_sub(5, 1));}})",
	          toString(fixed));
	EXPECT_EQ("[]", toString(core::checks::check(fixed)));
...
TEST(Manipulation, pushInto) {
	...
	EXPECT_EQ("{rec v0.{v0=fun(int<4> v1, int<4> v2) {return int_sub(v1, rec v0.{v0=fun(int<4> v1, int<4> v2) {return int_add(int_add(v1, v2), 2);}}(v1, v2));}}(10, v1);}",
	...
	EXPECT_EQ("{rec v0.{v0=fun(int<4> v1, int<4> v2) {return int_sub(v1, rec v0.{v0=fun(int<4> v1, int<4> v2) {return int_add(int_add(v1, v2), v2);}}(v1, v2));}}(10, v1);}",
...
TEST(Manipulation, pushIntoMultiple) {
	...
	EXPECT_EQ("{rec v0.{v0=fun(int<4> v1, int<4> v2, int<4> v3) {return int_add(int_sub(v1, rec v0.{v0=fun(int<4> v1, int<4> v2) {return int_add(v1, v2);}}(v1, v3)), v2);}}(10, v2, v1);}",
	          toString(*res));
