...
TEST(ASTBuilder, Basic) {
	...
	statements.push_back(build.declarationStmt(TYPE_BOOL_PTR, "test", build.boolLiteral(true)));
	...
	statements2.push_back(DeclarationStmt::get(*manager, TYPE_BOOL_PTR, "test", BoolLiteral::get(*manager, true)));
