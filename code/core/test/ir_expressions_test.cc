...
TEST(ExpressionsTest, LambdaExpr) {
	...
	EXPECT_EQ("rec v1.{v1=fun(uint<4> v3) {if(uint_eq(v3, 0)) {return true;} else {return bool_not(v2(v3));};}, v2=fun(uint<4> v3) {if(uint_eq(v3, 0)) {return false;} else {return bool_not(v1(v3));};}}",
	          toString(*even));
	EXPECT_EQ("rec v2.{v1=fun(uint<4> v3) {if(uint_eq(v3, 0)) {return true;} else {return bool_not(v2(v3));};}, v2=fun(uint<4> v3) {if(uint_eq(v3, 0)) {return false;} else {return bool_not(v1(v3));};}}",
	          toString(*odd));
}
...
TEST(ExpressionsTest, LambdaPeeling) {
	...
	EXPECT_EQ("rec v0.{v0=fun() {1; rec v0.{v0=fun() {rec v7.{v6=fun() {1; rec v0.{v0=fun() {v7();}}();}, v7=fun() {2; rec v0.{v0=fun() {v6();}}();}}();}}();}}",
