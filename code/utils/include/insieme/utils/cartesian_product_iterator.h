...
namespace utils {
	...
	namespace detail {
		...
		template<
			...
			typename ElementType = typename InnerIterator::value_type
		>
		class CartesianProductIterator :
				public std::iterator<std::input_iterator_tag, std::vector<ElementType>>,
	 ...
	 */
	template<
		typename NestedDataContainer,
		typename product_iter = detail::CartesianProductIterator<
