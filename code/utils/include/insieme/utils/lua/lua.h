...
namespace lua {
	...
	namespace function_wrapper {
		 ...
		 */
		template<typename T> struct extract_argument;

		// support booleans

		template<> struct extract_argument<bool> {
		...
		template<> struct extract_argument<uint8_t> 	: public extract_integer_argument<uint8_t> {};
		template<> struct extract_argument<uint16_t> 	: public extract_integer_argument<uint16_t> {};
		template<> struct extract_argument<uint32_t> 	: public extract_integer_argument<uint32_t> {};
		template<> struct extract_argument<uint64_t> 	: public extract_integer_argument<uint64_t> {};

		template<> struct extract_argument<int8_t> 		: public extract_integer_argument<int8_t> {};
		template<> struct extract_argument<int16_t> 	: public extract_integer_argument<int16_t> {};
		template<> struct extract_argument<int32_t> 	: public extract_integer_argument<int32_t> {};
		template<> struct extract_argument<int64_t> 	: public extract_integer_argument<int64_t> {};

		template<> struct extract_argument<float> 	: public extract_integer_argument<float> {};
		template<> struct extract_argument<double> 	: public extract_integer_argument<double> {};
		 ...
		 */
		template<typename T> struct extract_result : public extract_argument<T> {};
		 ...
		 */
		template<typename F, typename R, typename ... P> struct call;
		 ...
		 */
		template<typename F, typename R, typename ... P> struct executor;
		...
		template<typename F, typename ... P> struct executor<F, uint8_t, P...>  : public executor_numeric_res<F,uint8_t,P...> {};
		template<typename F, typename ... P> struct executor<F, uint16_t, P...> : public executor_numeric_res<F,uint16_t,P...> {};
		template<typename F, typename ... P> struct executor<F, uint32_t, P...> : public executor_numeric_res<F,uint32_t,P...> {};
		template<typename F, typename ... P> struct executor<F, uint64_t, P...> : public executor_numeric_res<F,uint64_t,P...> {};

		template<typename F, typename ... P> struct executor<F, int8_t, P...>  : public executor_numeric_res<F,int8_t,P...> {};
		template<typename F, typename ... P> struct executor<F, int16_t, P...> : public executor_numeric_res<F,int16_t,P...> {};
		template<typename F, typename ... P> struct executor<F, int32_t, P...> : public executor_numeric_res<F,int32_t,P...> {};
		template<typename F, typename ... P> struct executor<F, int64_t, P...> : public executor_numeric_res<F,int64_t,P...> {};

		template<typename F, typename ... P> struct executor<F, float, P...>  : public executor_numeric_res<F,float,P...> {};
		template<typename F, typename ... P> struct executor<F, double, P...> : public executor_numeric_res<F,double,P...> {};
