...
const string OmpRegionAnnotation::NAME = "OmpRegionAnnotation";
const utils::StringKey<OmpRegionAnnotation> OmpRegionAnnotation::KEY("OmpRegion");

void OmpRegionAnnotation::attach(const core::NodePtr& node) {
