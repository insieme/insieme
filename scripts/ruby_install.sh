...
echo "#### Building Ruby ####"
CC=$CC CXX=$CXX CFLAGS=$CFLAGS CXXFLAGS=$CXXFLAGS LDFLAGS=$LDFLAGS ./configure --prefix=$PREFIX/ruby-$VERSION --enable-shared --disable-install-doc --with-opt-dir=$PREFIX/yaml-latest/lib
make -j $SLOTS
