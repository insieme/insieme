...
rem DEBUG: cmake .. -G "Visual Studio 10" -DGTEST_ROOT=%GTEST_ROOT% -Dpthread_LIB=%PTHREAD_ROOT%\lib\pthreadVC2.lib -DLLVM_HOME=%LLVM_2_8% -DGLOG_HOME=%GLOG_ROOT%\ -DXERCES_INCLUDE_DIR=%XERCES_ROOT_DIR%\include -DXERCES_C_LIBRARY=%XERCES_ROOT_DIR%\lib\xerces-c_static_3.lib -DLINKING_TYPE=STATIC
