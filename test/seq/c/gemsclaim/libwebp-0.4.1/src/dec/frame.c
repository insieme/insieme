...
static int AllocateMemory(VP8Decoder* const dec) {
  ...
  uintptr_t mem_plus_mask = (uintptr_t)(mem + ALIGN_MASK);  // insieme: subexpression extracted
  mem = (uint8_t*)(mem_plus_mask & ~ALIGN_MASK);
    ...
    }
    {
      ...
      if (block->is_i4x4_) {   // 4x4
        ...
        for (n = 0; n < 16; ++n, bits <<= 2) {
          ...
          // ferdi: following line doesn't work: the reason seems to be bits initial value
