...
// Tests the correct implementation of default initialized members in the presence of ctors
...
struct DefaultInit : Base {
	...
	DefaultInit() {
		std::cout << "DefaultInit::ctor" << std::endl;
	}
};
