...
the \insCodeInl{ref<array<'type>>} with an actual \insCodeInl{ref<vector<'type>>}. All of
these are options which may be implemented right after the first phase of the
frontend has been processed. It may improve both the readability of the
generated IR code and possibility for optimizations. \note{Proposal for
'array-erasure' procedure useful to cleanup generated IR}.
