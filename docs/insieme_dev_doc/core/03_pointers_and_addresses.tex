...
\begin{lstlisting}
	core::StatementAddress a = someSource(..);
	// here a is automatically up-casted
	core::NodeAddress b = a;
	// also here
	b = a;
\end{lstlisting}
...
\begin{lstlisting}
	core::NodePtr a = someSource(..);
	core::StatementPtr b 
		= static_pointer_cast<StatementPtr>(a);
	core::StatementPtr c 
		= dynamic_pointer_cast<StatementPtr>(a);

	core::NodeAddress d = someSource(..);
	core::StatementAddress e 
		= static_address_cast<StatementAddress>(d);
	core::StatementAddress f 
		= dynamic_address_cast<StatementAddress>(d);
\end{lstlisting}
...
\begin{lstlisting}
	core::StatementPtr a 
		= someSource(..).as<StatementPtr>();
	core::StatementAddress b 
		= someSource(..).as<StatementAddress>();
\end{lstlisting}
...
\begin{lstlisting}
	core::ExpressionPtr a = someSource(..);
	// implicit
	core::StatementAddress b(a);
	// explicit
	b = core::StatementAddress(a);
\end{lstlisting}
...
\begin{lstlisting}
	core::ExpressionAddress a = someSource(..);
	core::StatementPtr b = a;
\end{lstlisting}
